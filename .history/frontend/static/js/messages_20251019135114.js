// ============================================================================
// ENHANCED MESSAGE MANAGEMENT - WITH LEAD PREVIEW
// ============================================================================
...
// ============================================================================
// GENERATE MESSAGES - WITH LEAD PREVIEW
// ============================================================================

async function generateMessages() {
    const btn = document.getElementById('generate-messages-btn');
    btn.disabled = true;
    btn.textContent = '⏳ Finding leads...';
    ...
    try {
        ...
        if (!leadsData.success || !leadsData.leads || leadsData.leads.length === 0) {
            throw new Error('No qualified leads found (score ≥ 70). Please approve some leads first!');
        }
        
        const leads = leadsData.leads;
        const leadNames = leads.map(l => l.name).join(', ');
        
        // Show confirmation with lead names
        const confirmed = confirm(`Generate messages for ${leads.length} leads?\n\n${leadNames}\n\nClick OK to continue.`);
        if (!confirmed) {
            btn.disabled = false;
        ...
        btn.textContent = '⏳ Generating 3 variants per lead...';

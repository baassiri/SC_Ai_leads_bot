...
async function generateMessagesForApprovedLeads(templateId) {
    ...
    if (templateId) {
        statusMessage.textContent = `🎨 Generating personalized messages using your template...`;
    } else {
        statusMessage.textContent = `⚡ Generating original messages (no template)...`;
    }
    ...
    try {
        ...
        if (data.success) {
            ...
            alert(`✅ Generated messages for ${pendingLeadIds.length} leads!`);
